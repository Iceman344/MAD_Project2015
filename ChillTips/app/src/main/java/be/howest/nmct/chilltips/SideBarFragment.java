...
public class SideBarFragment extends Fragment {
    ...
    private OnSideBarSelectionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((Button)v.findViewById(R.id.btn_overview)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onSidebarSelectInteraction(1);
            }
        });
        ((Button)v.findViewById(R.id.btn_addchill)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onSidebarSelectInteraction(2);
            }
        });
        return v;
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnSideBarSelectionListener) activity;
